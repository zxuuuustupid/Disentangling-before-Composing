...
class DBC(nn.Module):
    ...
    def train_forward_closed(self, x, epoch):
        ...
        loss = 0.33333*(self.lambda_res *loss_attr + loss_obj + self.lambda_res*loss_pos_attr + loss_pos_obj + self.lambda_res*loss_neg_attr + loss_neg_obj)
...
# Core
        if epoch >= self.res_epoch:
            ...
            loss_swap = self.lambda_rec * loss_swap_obj

...
parser.add_argument('--res_epoch', type=float, default=5, help='res_epoch')
parser.add_argument('--lambda_rep', type=float, default=1 / 4, help='weight of rep losses at the representation level')
parser.add_argument('--lambda_grad', type=float, default=1 / 2, help='weight of grad losses at the gradient level')
parser.add_argument('--lambda_rec', type=float, default=1 / 3, help='weight of rec losses at the erd')
parser.add_argument('--lambda_res', type=float, default=1 / 6, help='weight of res losses at the erd')
